...
const Dot: React.FC<DotProps> = ({
	...
	const gradientId = `paint0_linear_${Math.random()
		.toString(36)
		.substr(2, 9)}`;
	const clipId = `clip0_${Math.random().toString(36).substr(2, 9)}`;
...
export const DotExamples: React.FC = () => {
	return (
		<div className='flex flex-wrap gap-8 p-8 bg-gray-100 min-h-screen items-center justify-center'>
			{/* Default gray */}
			...
			<div className='text-center'>
				<Dot
					...
					size={100}
				/>
				<p className='mt-2 text-sm text-gray-600'>Orange</p>
			</div>
